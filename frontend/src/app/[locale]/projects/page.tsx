...
const projects = [
  ...
  },
  {
    ...
    description: 'ურბანული სივრცისა და რუკაზე დაფუძნებული გამოცდილების ციფრული მიმართულება, შექმნილი ქალაქის ინფორმაციის უფრო მკაფიოდ შესასწავლად.',
    capabilities: ['რუკაზე დაფუძნებული გამოცდილება', 'ურბანული მონაცემების ნავიგაცია', 'სივრცითი პროდუქტის ხედვა', 'ციფრული city interface'],
    impact: 'კომპლექსური სივრცითი კონტექსტი გადაყვანილია გასაგებ ციფრულ პროდუქტად.',
  },
  {
    name: 'Breeding.ge',
