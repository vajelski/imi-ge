...
export default function Footer({ siteSettings, footerBottomLinks, siteName = 'იმი.ჯი' }: FooterProps) {
  ...
  return <footer className="site-footer relative overflow-hidden bg-[#04132e] px-4 pb-4 pt-16 text-white sm:px-6"><div className="pointer-events-none absolute -left-48 top-0 size-[36rem] rounded-full bg-primary/30 blur-[150px]"/><div className="pointer-events-none absolute -right-48 bottom-0 size-[32rem] rounded-full bg-secondary/15 blur-[130px]"/>
